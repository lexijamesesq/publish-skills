...
- **Canopy Triad Sync** — weekly (Thursdays), cross-team product-leads sync. Registry key `canopy-triad-sync` (`Wiki/claude/skills/capture-meeting/meeting-registry.sample.json`).
