...
- `/lint-knowledge` — the sibling architecture (ships in the companion wiki repo, at `~/Repos/wiki/.claude/skills/lint-knowledge/`); its `lint.py` runtime-contract-parsing pattern is what `qa.py` reuses.
