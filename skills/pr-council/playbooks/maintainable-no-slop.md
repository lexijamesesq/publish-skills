...
**What you are given.** The floor's receipt (the checks that ran on this head and passed), the changed files and the **working-directory checkout** (the repository
