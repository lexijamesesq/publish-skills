...
# isn't plugin content at all (found live: this repo and wiki both needed
# a hand version bump on every dotty-bump PR for this exact reason; the
# same class of failure recurred for CODEOWNERS, and then again
# self-referentially for a fix to this exclude list itself).
